...
def test_sql_injection():
    ...
    nf_api_url_sqli = f"https://{NF_CONFIG['UDM_IP']}:{NF_CONFIG['UDM_PORT']}/api/profile"  #Endpoint de exemplo
    target_param = "id"
...
def test_command_injection():
    ...
    nf_mgmt_url = f"https://{NF_CONFIG['NEF_IP']}:{NF_CONFIG['NEF_PORT']}/management/ping"  #Endpoint de exemplo
